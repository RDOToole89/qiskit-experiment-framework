...
- **Quantum states**: Supports GHZ, W, G-CRY (configurable angles).
...
DEFAULT_STATE_TYPE = "GHZ"  # Options: "GHZ", "W", "G-CRY"
DEFAULT_NOISE_TYPE = "DEPOLARIZING"  # Options: "DEPOLARIZING", "PHASE_FLIP", "BIT_FLIP", etc.
...
DEFAULT_ERROR_RATE = 0.1  # Generic error probability (used in depolarizing, bit flip, etc.)
...
DEFAULT_GCRY_ANGLE = 2.0944  # π/3 radians, configurable for G-CRY states
