# src/quantum_experiment/utils/cli_parser.py
...
def parse_args() -> argparse.Namespace:
    """
    Parses command-line arguments for quantum experiment execution.
    """
    parser = argparse.ArgumentParser(description="Run a quantum experiment.")

    # Core experiment parameters
    parser.add_argument("--num_qubits", type=int, default=DEFAULT_NUM_QUBITS)
    parser.add_argument(
        "--state_type",
        type=str,
    ...
    parser.add_argument(
        "--noise_enabled", action="store_true", default=DEFAULT_NOISE_ENABLED
    )
    parser.add_argument("--shots", type=int, default=DEFAULT_SHOTS)
    parser.add_argument(
        "--sim_mode", type=str, choices=["qasm", "density"], default=DEFAULT_SIM_MODE
    )
